...
const FAQS = [
  ...
  },
  {
    ...
    a: "API 응답 데이터를 확인하거나 설정 파일을 정리할 때 유용합니다. 압축된 JSON을 붙여넣으면 들여쓰기된 형식으로 바꿔주고, 반대로 최소화가 필요하면 압축 모드로 전환하면 됩니다. 유효성 검사 기능도 포함되어 있어 문법 오류를 바로 확인할 수 있습니다.",
  },
  {
    q: "모바일에서도 도구를 쓸 수 있나요?",
    a: "네. 텍스터브의 모든 도구는 모바일 브라우저에서도 동작합니다. 다만 긴 텍스트 작업은 화면이 넓은 환경에서 더 편리합니다. 결과 복사 버튼을 사용하면 클립보드로 바로 옮길 수 있어 다른 앱과 연계해 쓰기 좋습니다.",
  },
];
