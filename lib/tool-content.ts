...
- **한글/영문 혼용**: 한글과 영어 사이의 간격이 너무 좁다면, 정리 후 맞춤법 검사기 도구와 함께 사용하는 것을 추천합니다.
  ...
  "word-frequency": {
    usageTips: [
      "불용어(이, 가, 은, 는 등) 필터 옵션을 켜면 의미 있는 단어만 분석할 수 있습니다.",
      "분석 결과를 CSV로 내보내 엑셀에서 추가 분석하세요.",
      "블로그 초안을 붙여넣어 특정 단어가 과도하게 반복되는지 확인하세요.",
      "키워드 밀도 분석에 활용하면 SEO에 도움이 됩니다.",
    ],
    faq: [
      {
        question: "단어 빈도 분석이란 무엇인가요?",
        answer:
          "텍스트에서 각 단어가 몇 번 등장하는지 세고, 자주 쓰인 단어를 순위별로 보여주는 분석입니다. 글쓰기의 반복 표현 점검, 키워드 밀도 확인, 어휘 다양성 분석에 활용됩니다.",
      },
      {
        question: "키워드 밀도는 어떻게 계산하나요?",
        answer:
          "키워드 밀도(%) = (특정 단어 등장 횟수 ÷ 전체 단어 수) × 100입니다. SEO에서는 주요 키워드 밀도를 1~3% 수준으로 유지하는 것이 권장됩니다.",
      },
      {
        question: "불용어(Stopword)가 무엇인가요?",
        answer:
          "'이', '가', '은', '는', '을', '를' 등 문법적 기능만 하는 단어로, 의미 분석 시 제외하면 더 유용한 결과를 얻을 수 있습니다. 불용어 필터 옵션을 활성화하면 자동으로 제외됩니다.",
      },
      {
        question: "분석 결과를 어떻게 활용하나요?",
        answer:
          "① 특정 단어의 과도한 반복 확인 → 동의어로 대체 ② 주요 키워드 빈도 체크 → SEO 키워드 밀도 최적화 ③ 어휘 다양성 분석 → 글의 질 개선에 활용하세요.",
      },
    ],
    relatedTools: ["char-counter", "sentence-counter", "meta-description-checker"],
    relatedGuides: ["blog-seo-basics-guide"],
    guideContent: `
## 단어 빈도 분석으로 글쓰기 품질 높이기

### 언제 사용하나요?

- **블로그 SEO 최적화**: 핵심 키워드가 충분히 사용됐는지 확인
- **자소서·보고서**: 특정 단어가 과도하게 반복되는지 점검
- **콘텐츠 어휘 다양성**: 같은 단어를 너무 자주 쓰는지 파악
...
1. 빈도 상위 단어가 해당 글의 핵심 키워드와 일치하는지 확인
2. 같은 단어가 3번 이상 연속 등장하면 동의어로 교체
3. 불용어를 제외한 상위 10개 단어가 글의 주제를 대표하는지 체크
`,
  },
