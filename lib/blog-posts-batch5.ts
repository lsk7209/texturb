...
---
*이 글은 AI가 공개 자료를 기반으로 작성했습니다. 최신 PR 가이드라인은 한국PR협회 공식 자료를 확인하세요.*`,
  },
  {
...
---
*이 글은 AI가 공개 자료를 기반으로 작성했습니다. WCAG 최신 버전은 W3C 공식 문서를 확인하세요.*`,
  },
  {
...
---
*이 글은 AI가 공개 자료를 기반으로 작성했습니다. 구글 알고리즘은 수시로 변경될 수 있으니 Google Search Central 블로그를 함께 참조하세요.*`,
  },
  {
...
---
*이 글은 AI가 공개 자료를 기반으로 작성했습니다. 문서 장르에 따라 반복 허용 기준이 다를 수 있습니다.*`,
  },
  {
...
---
*이 글은 AI가 공개 자료를 기반으로 작성했습니다. 기관·출판사별 스타일 가이드가 다를 수 있으므로 담당자에게 확인하세요.*`,
  },
  {
...
---
*이 글은 AI가 공개 자료를 기반으로 작성했습니다. 플랫폼별 마크다운 구현 차이는 각 플랫폼 공식 문서를 참조하세요.*`,
  },
  {
...
---
*이 글은 AI가 공개 자료를 기반으로 작성했습니다. 각 기업의 지원 기준은 공식 채용 공고를 확인하세요.*`,
  },
  {
...
---
*이 글은 AI가 공개 자료를 기반으로 작성했습니다. 기업·기관별 기획서 양식 기준이 다를 수 있으므로 담당 부서에 확인하세요.*`,
  },
  {
...
---
*이 글은 AI가 공개 자료를 기반으로 작성했습니다. 채용 담당자의 선호는 기업마다 다를 수 있습니다.*`,
  },
  {
