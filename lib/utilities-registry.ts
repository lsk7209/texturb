export type UtilityTool = {
  ...
  showOnHome?: boolean
  tabId?: "cleanup" | "count" | "format" | "highlight" | "analysis"
}
...
export const UTILITIES: UtilityTool[] = [
  ...
  // Phase 4: 분석 및 고급 도구
  {
    ...
    category: "글 길이/분량",
    description: "텍스트의 가독성을 점수로 측정하고 개선 제안을 제공합니다.",
    keywords: ["가독성", "읽기 쉬움", "문장 난이도", "Flesch"],
    showOnHome: false,
    tabId: "count",
  },
  {
    ...
    category: "메타·SEO",
    description: "텍스트 내 키워드 빈도와 밀도를 분석하여 SEO 최적화를 돕습니다.",
    keywords: ["키워드", "SEO", "밀도", "빈도"],
    showOnHome: false,
    tabId: "count",
  },
  {
    ...
    category: "분석",
    description: "두 텍스트를 비교하여 차이점을 찾고 유사도를 계산합니다.",
    keywords: ["비교", "차이점", "유사도", "diff"],
    showOnHome: false,
    tabId: "analysis",
  },
  {
  ...
  },
  {
    ...
    name: "문장 난이도 분석기",
    slug: "sentence-difficulty",
    category: "분석",
    description: "문장의 난이도를 분석하고 읽기 수준을 평가합니다.",
    keywords: ["난이도", "읽기 수준", "문장 분석"],
    showOnHome: false,
    tabId: "analysis",
  },
  {
    ...
    category: "분석",
    description: "긴 텍스트를 요약하여 핵심 내용을 추출합니다.",
    keywords: ["요약", "핵심", "추출", "요약문"],
    showOnHome: false,
    tabId: "analysis",
  },
  {
    ...
    slug: "keyword-cloud",
    category: "분석",
    description: "텍스트에서 키워드를 추출하여 클라우드 형태로 시각화합니다.",
    keywords: ["키워드 클라우드", "워드 클라우드", "시각화"],
    showOnHome: false,
    tabId: "analysis",
  },
  {
    ...
    category: "분석",
    description: "텍스트의 다양한 통계 정보를 한눈에 확인할 수 있는 대시보드입니다.",
    keywords: ["통계", "대시보드", "분석", "인사이트"],
    showOnHome: false,
    tabId: "analysis",
  },
  {
    ...
    slug: "csv-cleaner",
    category: "추출·정리",
    description: "CSV/TSV 데이터를 정리하고 검증하며 포맷을 변환합니다.",
    keywords: ["CSV", "TSV", "데이터 정리", "스프레드시트"],
    showOnHome: false,
    tabId: "format",
  },
  {
    ...
    slug: "json-formatter",
    category: "변환",
    description: "JSON 데이터를 포맷팅하고 검증하며 압축/확장합니다.",
    keywords: ["JSON", "포맷팅", "검증", "정리"],
    showOnHome: false,
    tabId: "format",
  },
]
